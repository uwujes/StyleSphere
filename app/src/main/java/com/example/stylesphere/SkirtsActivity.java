...
public class SkirtsActivity extends AppCompatActivity {
    ...
    private ActivitySkirtsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySkirtsBinding.inflate(getLayoutInflater());
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            Toast.makeText(SkirtsActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mImageUri != null) {
                    ...
                    Toast.makeText(SkirtsActivity.this, "Please select image", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void uploadToFirebase(Uri uri) {
        ...
        imageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                mProgressBar.setVisibility(View.INVISIBLE);
                Toast.makeText(SkirtsActivity.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
